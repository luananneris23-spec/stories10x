...
const MECANISMOS = [
  ...
  { id:5 , nome:"Meta Coletiva                         ", cat:"engajamento", desc:"Estipular uma meta para a comunidade engajar e receber um benefício. Tem que ser algo de interesse geral do público-alvo e gerar sensação de grupo e pertencimento.", ex:"Se esse story tiver 200 respostas até as 18h, eu solto o conteúdo exclusivo que ainda não mostrei pra ninguém." },
  { id:6 , nome:"História com Gancho                   ", cat:"conexao    ", desc:"Contar uma história sua ou de alguém que gera contexto para uma ação específica de acordo com o objetivo daquela sequência. A história precisa ser bem contada na linguagem do público ideal.", ex:"Hoje eu vou contar a história do dia que eu quase desisti de tudo — e o que me fez continuar." },
  { id:7 , nome:"Cultura de Resultado                  ", cat:"prova      ", desc:"Incentivar a audiência a mostrar resultados obtidos a partir de algo que aprendeu com você ou que esteja alinhado com o que você ensina. Serve de prova social.", ex:"Me manda o resultado que você teve depois de aplicar o que eu ensinei — vou compartilhar aqui!" },
  { id:8 , nome:"Piada Interna                         ", cat:"conexao    ", desc:"Criar piadas internas dentro da realidade do público-alvo e firmá-las por repetição. O ideal é ter umas 3 piadas internas e sempre repeti-las quando usar esse mecanismo, criando assim uma identidade de comunidade.", ex:"Toda vez que alguém falar [X], a comunidade já sabe o que vem a seguir — repita sempre." },
  { id:9 , nome:"Pânico pelo Conteúdo                  ", cat:"antecipacao", desc:"Gerar forte antecipação com gancho forte e informar o horário exato em que vai soltar o conteúdo. O gancho precisa ser fixado na cabeça do público para ele voltar no horário. Pode ser uma polêmica, um tabu, um desejo muito forte da audiência, um medo grande, etc.", ex:"Hoje às 20h eu vou revelar algo que nunca contei sobre [assunto]. Ativa a notificação para não perder." },
  { id:10, nome:"Ansiedade pela Abertura               ", cat:"antecipacao", desc:"Incentivar comprovante de ação — quem já está com cartão na mão, quem já está com o caderno e a caneta preparados. O intuito é mostrar para quem não fez que está de fora de um movimento e trazer para quem fez a sensação de pertencimento.", ex:"Quem já está com o caderno e a caneta preparados pra aula de hoje, manda aqui pra eu saber! ✏️" },
  { id:11, nome:"Abertura de Carrinho                  ", cat:"vendas     ", desc:"Gerar antecipação pela abertura de carrinho destacando benefícios, bônus únicos, condição exclusiva e qualidade. Algo que faça a pessoa querer correr para comprar assim que estiver disponível.", ex:"Amanhã às 9h abre o carrinho com bônus exclusivo para os primeiros. Não vai querer ficar de fora." },
  { id:12, nome:"Ative a Notificação                   ", cat:"antecipacao", desc:"Gerar expectativa por conteúdo futuro ao final de algo muito bom, fazendo o público querer receber mais. Funciona bem combinado com o Pânico pelo Conteúdo levando a audiência a ativar a notificação para não perder.", ex:"Ativa a notificação do meu perfil para não perder o que vem por aí — vai ser muito bom." },
  { id:13, nome:"Alerta para Voltar                    ", cat:"engajamento", desc:"Convidar o público a voltar os stories para tomar alguma ação: ver uma informação importante destacada depois, pegar um presente surpresa escondido em um story anterior, encontrar um erro e ganhar prêmio, printar algo que vai precisar, etc. O objetivo é fazer o algoritmo entender que a sequência é tão relevante que as pessoas voltam para rever.", ex:"Volta no 3º story que eu deixei uma informação importante lá que vale muito a pena printar." },
  { id:14, nome:"BI Apurado                            ", cat:"pesquisa   ", desc:"Realizar uma pesquisa com a audiência para conhecê-la melhor e gerar engajamento, possibilidades de vendas e ofertas de acordo com as respostas.", ex:"Me conta: qual é o maior desafio que você enfrenta hoje em [tema do nicho]? Quero entender melhor pra te ajudar." },
  { id:15, nome:"Print Valioso                         ", cat:"engajamento", desc:"Incentivar a audiência a tirar print de algum conteúdo que ela vai precisar se lembrar sempre, que pode mudar a maneira dela de fazer algo, ou de uma indicação de filme, livro, etc.", ex:"Printa esse aqui — você vai querer lembrar disso quando estiver passando por [situação do nicho]." },
  { id:16, nome:"Identidade do Comunicador             ", cat:"conexao    ", desc:"Demonstrar sua identidade de comunicador trazendo seu diferencial competitivo, a maneira como você enxerga as coisas, seu posicionamento, suas vivências, sua opinião em assuntos em alta, etc.", ex:"Na minha visão, [opinião forte sobre algo do nicho]. Pode discordar, mas é assim que eu enxergo." },
  { id:17, nome:"Identidade do Produto                 ", cat:"vendas     ", desc:"Demonstrar a identidade do produto: quem ele atende, para quem é pensado, qual dor ele resolve, quais benefícios ele traz, etc.", ex:"Esse produto foi criado para [perfil específico] que sofre com [dor]. Ele resolve [problema] entregando [benefício]." },
  { id:18, nome:"Identidade do Consumidor              ", cat:"conexao    ", desc:"Dar voz para o consumidor ideal engajando ele na sua causa, incentivando ele a falar e a participar sempre trazendo contexto.", ex:"Você que [característica do cliente ideal], esse story é pra você. Me conta: você se identifica com isso?" },
  { id:19, nome:"Desabafo                              ", cat:"conexao    ", desc:"Estimular o público a desabafar a partir de uma questão em comum. Você pode colocar um desabafo seu, de outra pessoa ou de uma situação e a partir disso incentivar o desabafo da audiência.", ex:"Eu preciso desabafar sobre [situação]... Alguém mais já se sentiu assim? Me conta por inbox." },
  { id:20, nome:"Opinião de Quem Comprou               ", cat:"prova      ", desc:"Incentivar quem comprou a dar sua opinião sobre o produto ou serviço — mostrando a opinião de alguém e provocando interação, falando dos benefícios e incentivando o feedback, ou por outras maneiras criativas.", ex:"Se você já usou [produto], me conta aqui: o que mudou pra você depois disso?" },
  { id:21, nome:"Peça Compartilhamento                 ", cat:"crescimento", desc:"Incentivar o público a compartilhar o conteúdo com um apelo emocional — para ajudar uma amiga, mandar para alguém especial, alguém que merece ler isso, que merece receber esse presente também.", ex:"Se isso fez sentido pra você, manda pra aquela amiga que precisa ouvir isso hoje. Ela vai te agradecer. 🧡" },
  { id:22, nome:"Nomes Esquisitos                      ", cat:"conexao    ", desc:"Utilizar nomes próprios na comunicação fazendo alegorias únicas que ajudam o público a fixar melhor a mensagem. Usá-las sempre para criar identidade e fixação.", ex:"Eu chamo isso de [nome criativo e inusitado] — e depois que você souber o que é, nunca mais vai esquecer." },
  { id:23, nome:"Espetacularização                     ", cat:"conexao    ", desc:"Exaltar uma ação comum do público-alvo destacando-a ao máximo e exagerando para torná-la divertida e especial.", ex:"Isso que você faz todo dia sem perceber é na verdade [exagero divertido e espetacular]." },
  { id:24, nome:"Você Sabia                            ", cat:"conteudo   ", desc:"Encontrar e trazer curiosidades em relação ao nicho — pode ser algo educativo, engraçado, contraditório, transformador ou inspirador. Sempre precisa ser verdadeiro e comprovado.", ex:"Você sabia que [curiosidade real e surpreendente do nicho]? Isso muda tudo quando você entende." },
  { id:25, nome:"Micro Influência                      ", cat:"conexao    ", desc:"Recomendar algo para a audiência que vai fazer com que, ao ter acesso àquilo, ela lembre de você — ganhando espaço na mente do público. Pode ser um produto, uma série, um filme, uma estratégia, um app, etc.", ex:"Descobri um [produto/série/app] que mudou minha rotina e preciso te contar — você vai lembrar de mim toda vez que usar." },
  { id:26, nome:"Presente Difícil                      ", cat:"engajamento", desc:"Incentivar o engajamento oferecendo um bom presente para quem fizer algo relativamente difícil para conquistá-lo. Tem que ser algo de real interesse do público-alvo e tudo direcionado ao nicho.", ex:"Quem fizer [ação desafiadora do nicho] e me mandar aqui vai ganhar [presente de real valor]. Vai encarar?" },
  { id:27, nome:"Elemento Escondido                    ", cat:"engajamento", desc:"Ter algo escondido na sequência — um link secreto de oferta ou presente, uma resposta escondida, uma estratégia, um cupom, um desconto, etc.", ex:"Deixei algo escondido nessa sequência de stories... Quem achar me manda por inbox que eu confirmo. 👀" },
  { id:28, nome:"Tarja de Curiosidade                  ", cat:"conteudo   ", desc:"Esconder a parte importante do conteúdo — o que foi usado para um excelente resultado, uma polêmica envolvendo alguém, um conteúdo para saber se o público sabe, uma collab que você quer manter em mistério, etc.", ex:"Eu consegui [resultado incrível] usando isso aqui 👉 [tarja]. Primeira que adivinhar o que é, eu conto tudo." },
  { id:29, nome:"Psicologia Reversa                    ", cat:"vendas     ", desc:"Pegar algo comum do público-alvo e dar uma resposta contraintuitiva que surpreende e gera reflexão ou ação.", ex:"Todo mundo diz pra fazer [X], mas eu faço o contrário — e é exatamente por isso que [resultado inesperado]." },
  { id:30, nome:"Resumo                                ", cat:"conteudo   ", desc:"Pedir um resumo de um conteúdo seu oferecendo um prêmio. Pode ser pedindo para colocar o resumo na legenda do conteúdo ou mandar por inbox.", ex:"O melhor resumo do que eu ensinei hoje ganha [prêmio]. Me manda por inbox até [horário]." },
  { id:31, nome:"7 Erros                               ", cat:"engajamento", desc:"Pedir para encontrar o erro incentivando o público a engajar. Pode combinar com prêmio. Pode usar imagens, textos ou o que melhor se encaixar com o nicho.", ex:"Tem um erro escondido nessa imagem/texto. Quem encontrar primeiro me manda por inbox — tem surpresa pra você! 🔍" },
  { id:32, nome:"Diário                                ", cat:"conexao    ", desc:"Falar sobre um momento, um dia ou uma situação levando a audiência de um ponto a outro com você. Mais pessoal, mais profundo.", ex:"Hoje foi um dia [adjetivo]. Vou te contar como começou e como terminou — porque teve uma virada que não esperava." },
  { id:33, nome:"Crítica                               ", cat:"engajamento", desc:"Trazer um inimigo em comum, uma situação ruim em comum, uma dificuldade em comum e provocar o público a se expressar e criticar.", ex:"Isso aqui me incomoda demais no [nicho]. Só eu que acho um absurdo ou você também? Me conta." },
  { id:34, nome:"Demonstração Curta                    ", cat:"vendas     ", desc:"Demonstrar o produto ou método mostrando como a solução funciona na prática.", ex:"Em 30 segundos vou te mostrar como [produto/método] funciona na prática — olha o resultado." },
  { id:35, nome:"Enquete com Curiosidade Real          ", cat:"pesquisa   ", desc:"Fazer perguntas que o público tem curiosidade em saber o resultado — para saber se estão na média, se estão dentro do esperado, ou descobrir algo sobre si mesmos.", ex:"Quanto tempo você leva pra [ação do nicho]? (A) menos de X / (B) mais de X — vou mostrar a média depois!" },
  { id:36, nome:"Link Oculto                           ", cat:"vendas     ", desc:"Colocar o link com um nome chamativo ou curioso onde a pessoa não sabe o que vai acessar. Ou colocar apenas os benefícios e o link com 'clique aqui para descobrir o que é', sem revelar o nome do produto.", ex:"Não seja curiosa e não clica aqui 👆 — ou clica, se quiser descobrir o que eu preparei pra você." },
  { id:37, nome:"Indicação Pretensiosa                 ", cat:"engajamento", desc:"Pedir ajuda dos seguidores pedindo para eles enviarem indicações de algo. É um tira-dúvidas e troca de indicações com a audiência.", ex:"Queria muito uma indicação de [algo do nicho]. Você conhece algum bom? Me manda aqui que eu leio todos!" },
  { id:38, nome:"Levante a Mão                         ", cat:"vendas     ", desc:"Fazer triagem no público para achar os mais prontos para comprar, oferecendo uma ligação, call, áudio ou algo mais próximo para quem está com dúvidas e tem interesse.", ex:"Se você tem interesse em [produto/serviço] mas ainda tem dúvidas, me manda aqui que eu te mando um áudio explicando tudo." },
];
